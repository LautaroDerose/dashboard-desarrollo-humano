...
import { dataGraphics } from "../../constants/fake-data"
import TotalSuscribers from "./TotalSuscribers"
...
export default function GraphicComponent() {
  return (
    <div className='mt-5'>
      <div>
        <p className='text-3xl mb-3 '>24.567</p>
        <div className='flex gap-x-5 mb-5'>
          <div className='flex items-center gap-2 px-3 text-md bg-teal-600 text-white rounded-xl w-fit'>
            8,5%
