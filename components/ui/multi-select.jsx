...
const MultiSelector = ({
  ...
  const onValueChangeHandler = useCallback(
    ...
    [value, onValueChange] // Include `onValueChange` in the dependency array
  );
  ...
  const handleKeyDown = useCallback(
    ...
    [value, inputValue, activeIndex, loop, onValueChange, dir] // Include `dir` and `onValueChange` in the dependency array
  );
  return (
