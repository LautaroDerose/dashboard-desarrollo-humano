  ...
  return (
    (<DayPicker
      ...
      components={{
        ...
        // Convertir los hijos en un array de elementos React
        const options = React.Children.toArray(children);
        // Encontrar el elemento seleccionado basado en el valor
        const seleccionado = options.find((child) => child.props.value === value);
