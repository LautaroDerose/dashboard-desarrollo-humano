import { columns } from "@/app/(roles-internos)/(desarrollo-humano)/secretaria_dh/list/(table)/columns";
import { DataTable } from "@/app/(roles-internos)/(desarrollo-humano)/secretaria_dh/list/(table)/data-table";
import prisma from "@/lib/prisma";

export default async function ClientTableSecretaria() {
  try {
