          ...
          <CardContent>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-3 ">
                ...
                <div>
                  <p className="font-light py-2  ">Tipo: <span className="font-bold ml-2">Decreto </span></p>
                  <Separator />
                </div>
                <div>
                  {
                    assignment.subsidy_stage.note_doc.is_confirm
                    ? <CreateDecreeDocForm assignmentId={assignment.id} buttonName={"Crear Decreto"}/>
                    : <Button variant="secondary" className="cursor-not-allowed " >Debes recibir la nota fisica para crear decreto</Button>
                  }
