...
export default function StatusCardAssignments({ rechazados, enProceso, pendientes, concretados, enRevision}) {
  ...
  return(
    <div className="grid gap-4 md:grid-cols-2 md:gap-4 lg:grid-cols-5 mt-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{enRevision} Asignaciones</div>
      ...
      <Card >
        ...
        <CardContent>
          <div className="text-2xl font-bold">{concretados} Asignacion/es</div>
          <p className="text-xs text-muted-foreground">
            +201 since last hour
          </p>
        </CardContent>
